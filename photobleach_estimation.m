...
function [result] = photobleach_estimation(traces, n)
    ...
    for i=1:size(traces, 2)
            ...
            trace = medfilt1(trace, 1001, 'truncate');  

            % Pierre commented out this NaN conditional because individual traces were removed by replacing them with NaNs; this way trace indices remains consistent across trials
            %if ~any(isnan(trace))
